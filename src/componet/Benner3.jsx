...
export default function Banner3() {
  ...
  return (
    <section className="relative w-full bg-[#b88242] overflow-hidden py-16 px-6 md:px-12 lg:px-20 min-h-[400px] flex items-center mt-10">
      ...
      {/* Background Decorative Abstract Circles */}
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        {/* Right Side: Graphic Collage / Hoodie Showcase */}
        <div className="relative w-full h-[350px] md:h-[300px] flex items-center justify-center lg:justify-end">
          <div className="absolute z-20 right-[22%] md:right-[28%] lg:right-[14%] top-1/2 -translate-y-1/2 w-48 min-w-[450px] md:w-64 drop-shadow-2xl transition-transform hover:scale-105 duration-300">
